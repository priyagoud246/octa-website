...
export default function AdminDashboard() {
  ...
  return (
    <div style={{ padding: isMobile ? '24px 16px' : '40px 48px', maxWidth:1400, margin:'0 auto', boxSizing:'border-box' }}>
          ...
          >
            ...
            <div style={{ display:'flex', justifyContent:'space-between', alignItems:'flex-start', marginBottom:24, gap:12 }}>
              <div style={{ flex:1, minWidth:0 }}>
                <div style={{ fontFamily:'Sora,sans-serif', fontSize: isMobile ? 18 : 22, fontWeight:700, marginBottom:4 }}>
            ...
            <div style={{
              ...
              {[
                ...
                <div key={label} style={{ background:'rgba(255,255,255,0.06)', border:'1px solid rgba(255,255,255,0.1)', borderRadius:12, padding:'12px 14px' }}>
                  <div style={{ fontSize:11, letterSpacing:'0.1em', textTransform:'uppercase', color:'rgba(255,255,255,0.4)', marginBottom:5 }}>{icon} {label}</div>
                  {href
                    ? <a href={href} style={{ fontSize:13, color:'#c8dedd', textDecoration:'none', wordBreak:'break-all' }}>{value}</a>
            ...
            {/* Interest */}
            <div style={{ background:'rgba(255,255,255,0.06)', border:'1px solid rgba(255,255,255,0.1)', borderRadius:12, padding:'12px 14px', marginBottom:12 }}>
              <div style={{ fontSize:11, letterSpacing:'0.1em', textTransform:'uppercase', color:'rgba(255,255,255,0.4)', marginBottom:5 }}>🎯 Interested In</div>
              <div style={{ fontSize:13, color:'#c8dedd', fontWeight:500 }}>{selected.interest}</div>
            </div>

            {/* Message */}
            {selected.message && (
              <div style={{ background:'rgba(255,255,255,0.06)', border:'1px solid rgba(255,255,255,0.1)', borderRadius:12, padding:'12px 14px', marginBottom:16 }}>
                <div style={{ fontSize:11, letterSpacing:'0.1em', textTransform:'uppercase', color:'rgba(255,255,255,0.4)', marginBottom:6 }}>💬 Message</div>
            ...
            <div style={{ marginBottom:16 }}>
              <span style={{ fontSize:12, color:'rgba(255,255,255,0.5)', display:'block', marginBottom:10 }}>Update status:</span>
      ...
      <div style={{ display:'flex', justifyContent:'space-between', alignItems:'flex-start', marginBottom: isMobile ? 24 : 40, flexWrap:'wrap', gap:16 }}>
        <div>
          ...
          <h2 className="sec-title" style={{ marginBottom:6, fontSize:'clamp(24px,3vw,40px)' }}>Dashboard</h2>
        ...
        <div style={{
          ...
          {[
            ...
            >
              ...
              <div style={{ fontFamily:'Sora,sans-serif', fontSize: isMobile ? 26 : 36, fontWeight:800, color, lineHeight:1, marginBottom:6 }}>{val}</div>
          ...
          <div style={{ padding:'12px 16px', display:'flex', flexDirection:'column', gap:10 }}>
            {filtered.length === 0 ? (
              ...
              >
                ...
                <div style={{ fontSize:12, color:'rgba(200,222,221,0.7)', marginBottom:4 }}>📧 {e.email}</div>
                <div style={{ fontSize:12, color:'rgba(255,255,255,0.5)', marginBottom:6 }}>🏥 {e.institution}</div>
                <div style={{ display:'flex', justifyContent:'space-between', alignItems:'center', gap:8 }}>
                  <div style={{ fontSize:11, color:'rgba(255,255,255,0.4)', flex:1, overflow:'hidden', textOverflow:'ellipsis', whiteSpace:'nowrap' }}>
                    {e.interest}
                  </div>
